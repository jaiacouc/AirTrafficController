# CSC 362 Project - Fall 2021

## Project description

This repository is for your three-part CSC 362 project, which will
proceed in three two-week long assignments (the last one will actually
be 20 days, but spans the Thanksgiving break). The final project,
which will be a multithreaded, networked air traffic ground control
server, will be due at midnight on the last day of the semester:
Wednesday, December 1. This assignment is different from the
...
* To make sure you can proceed to later parts of the assignment, since
  ...
  each part has passed. For example, Part 1 is due on Thursday,
  October 28, and Part 2 is due on Thursday, November 11 -- on Friday
...
## Part 1 (v0.1): Creating the basic command processor (due Thurs, Oct 28)
...
## Part 2 (v0.2): Creating the network server and communication threads (due Thurs, Nov 11)
...
## Part 3 (v1.0): Completing the server (due Wed, Dec 1)
